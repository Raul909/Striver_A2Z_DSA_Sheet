...
//     return 0;
// }
//In the above method we use the concept of sets so that unique subsets are stored 




//in the following method other method is used and no extra set is created or used 
//we used here another concept
